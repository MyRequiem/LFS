...
# После пересборки gcc убедимся, что основные функции (компиляция и компоновка)
# цепочки инструментов сборки работают должным образом. Для проверки
# работоспособности создадим простейший C-файл и скомпилируем его собранным
# нами gcc
