...
PRGNAME="python3-html5lib"
ARCH_NAME="html5lib"

### html5lib (pure-python library for parsing HTML)
# Библиотека анализа HTML, предназначенная для спецификации HTML WHATWG
...
# Package: ${PRGNAME} (pure-python library for parsing HTML)
#
# html5lib provides a pure-python library for parsing HTML. It is designed to
