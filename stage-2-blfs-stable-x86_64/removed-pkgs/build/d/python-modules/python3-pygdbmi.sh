...
PRGNAME="python3-pygdbmi"
ARCH_NAME="pygdbmi"

### pygdbmi (Get Structured Output from GDB's Machine Interface)
# Машинно-ориентированный текстовый интерфейс для GDB
...
# Package: ${PRGNAME} (Get Structured Output from GDB's Machine Interface)
#
# GDB/MI is a line based machine oriented text interface to GDB and is
# activated by specifying using the --interpreter command line option (see Mode
# Options). It is specifically intended to support the development of systems
# which use the debugger as just one small component of a larger system.
#
