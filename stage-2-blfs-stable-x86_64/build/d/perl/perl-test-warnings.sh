...
PRGNAME="perl-test-warnings"
ARCH_NAME="Test-Warnings"

### Test::Warnings (Test::Warnings Perl module)
# Perl модуль для тестов на предупреждения и их отсутствие
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Test/Warnings/.packlist"
...
# Package: ${PRGNAME} (Test::Warnings Perl module)
#
# Test::Warnings tests for warnings and the lack of them
#
# Home page: https://metacpan.org/pod/Test::Warnings
