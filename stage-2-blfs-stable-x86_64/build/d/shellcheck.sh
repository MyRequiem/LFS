...
# Интеллектуальный помощник для написания Bash-скриптов. Находит скрытые
# ошибки, лишние пробелы и потенциальные проблемы с безопасностью еще до
# запуска скрипта. Дает советы по написанию более надежного кода.
