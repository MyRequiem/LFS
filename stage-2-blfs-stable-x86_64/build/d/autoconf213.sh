...
# http://www.linuxfromscratch.org/blfs/view/stable/general/autoconf213.html

# Home page: http://www.gnu.org/software/autoconf/
# Download:  https://ftp.gnu.org/gnu/autoconf/autoconf-2.13.tar.gz
...
install -v -m644 "${PRGNAME}.info" /usr/share/info
install -v -m644 "${PRGNAME}.info" "${TMP_DIR}/usr/share/info"

install-info --info-dir=/usr/share/info             "${PRGNAME}.info"
install-info --info-dir="${TMP_DIR}/usr/share/info" "${PRGNAME}.info"
