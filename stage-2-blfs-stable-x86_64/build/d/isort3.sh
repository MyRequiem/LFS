...
# не конфликтуем с пакетом isort2
(
...
# Download:  https://files.pythonhosted.org/packages/ab/e9/964cb0b2eedd80c92f5172f1f8ae0443781a9d461c1372a3ce5762489593/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
