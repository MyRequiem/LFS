...
PRGNAME="python3-webencodings"
ARCH_NAME="webencodings"

### webencodings (implementation of WHATWG Encoding standard)
# Реализация стандарта кодирования WHATWG на Python
...
# Package: ${PRGNAME} (implementation of WHATWG Encoding standard)
#
# The webencodings module is a Python implementation of the WHATWG Encoding
# standard
#
