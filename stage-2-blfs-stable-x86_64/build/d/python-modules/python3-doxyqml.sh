...
PRGNAME="python3-doxyqml"
ARCH_NAME="doxyqml"

### Doxyqml (allows using Doxygen to document QML classes)
# Позволяет использовать Doxygen для документирования QML-классов

# Required:    doxygen          (runtime)
# Recommended: no
...
# Package: ${PRGNAME} (allows using Doxygen to document QML classes)
#
