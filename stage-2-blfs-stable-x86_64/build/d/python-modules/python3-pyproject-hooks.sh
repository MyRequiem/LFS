...
PRGNAME="python3-pyproject-hooks"
...
# Package: ${PRGNAME} (wrappers to call PEP 517 build backend hooks)
#
# This is a low-level library for calling build-backends in
# pyproject.toml-based project. It provides the basic functionality to help
