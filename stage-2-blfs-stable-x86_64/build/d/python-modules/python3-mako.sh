...
# Сверхбыстрый «движок» для создания текстовых шаблонов. Программисты
# используют его, чтобы быстро генерировать веб-страницы или части программного
# кода на основе заданных правил.
