...
PRGNAME="python3-certifi"
ARCH_NAME="certifi"

### certifi (collection of Root Certificates)
# Коллекция сертификатов для проверки подлинности SSL от Mozilla
...
# Package: ${PRGNAME} (collection of Root Certificates)
#
# The certifi module provides Mozilla’s carefully curated collection of Root
# Certificates for validating the trustworthiness of SSL certificates while
# verifying the identity of TLS hosts
#
