...
# Библиотека для проверки, сортировки и манипуляции сетевыми адресами IPv4 и
# IPv6. В современном Python она считается устаревшей, но до сих пор
# присутствует в системе как обязательная зависимость для работы графического
