...
PRGNAME="python-appdirs"
ARCH_NAME="appdirs"

### appdirs (determining appropriate platform-specific dirs)
...
# Download:  https://files.pythonhosted.org/packages/d7/d8/05696357e0311f5b5c316d7b95f46c669dd9c15aaeecbb48c7d0aeb88c40/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
