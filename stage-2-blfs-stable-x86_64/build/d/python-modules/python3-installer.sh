...
PRGNAME="python3-installer"
ARCH_NAME="installer"

### Installer (library for installing Python packages from wheels)
# Компактная библиотека для чистой установки Python-пакетов из готовых
# wheel-архивов. Используется сборочными скриптами как легковесная альтернатива
# утилите pip, чтобы правильно разложить файлы скомпилированного модуля по
# системным каталогам.
...
# Package: ${PRGNAME} (library for installing Python packages from wheels)
#
