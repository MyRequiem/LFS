...
PRGNAME="perl-parse-yapp"
ARCH_NAME="Parse-Yapp"

### Parse::Yapp (Perl extension for generating and using LALR parsers)
# Parse::Yapp Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Parse/Yapp/.packlist"
...
# Package: ${PRGNAME} (Perl extension for generating and using LALR parsers)
#
# Parse::Yapp is a Perl extension for generating and using LALR parsers
#
# Home page: https://metacpan.org/pod/Parse::Yapp
# Download:  https://www.cpan.org/authors/id/W/WB/WBRASWELL/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
