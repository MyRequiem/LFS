...
PRGNAME="perl-file-sharedir-install"
ARCH_NAME="File-ShareDir-Install"

### File::ShareDir::Install (install shared files)
# File::ShareDir::Install Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/File/ShareDir/Install/.packlist"
...
# Package: ${PRGNAME} (install shared files)
#
# File::ShareDir::Install allows you to install read-only data files from a
# distribution
#
# Home page: https://metacpan.org/pod/File::ShareDir::Install
