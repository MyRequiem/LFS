...
PRGNAME="perl-net-http"
ARCH_NAME="Net-HTTP"

### Net::HTTP (low-level HTTP connection (client))
# Net::HTTP Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Net/HTTP/.packlist"
