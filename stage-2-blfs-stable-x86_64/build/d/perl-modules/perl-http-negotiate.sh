...
PRGNAME="perl-http-negotiate"
ARCH_NAME="HTTP-Negotiate"

### HTTP::Negotiate (choose a variant to serve)
# HTTP::Negotiate Perl модуль

# Required:    no
# Recommended: perl-http-message (для тестов)
# Optional:    no
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/HTTP/Negotiate/.packlist"
...
# Package: ${PRGNAME} (choose a variant to serve)
#
# HTTP::Negotiate provides a complete implementation of the HTTP content
# negotiation algorithm
#
# Home page: https://metacpan.org/pod/HTTP::Negotiate
