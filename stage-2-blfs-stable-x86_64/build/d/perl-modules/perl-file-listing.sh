...
PRGNAME="perl-file-listing"
ARCH_NAME="File-Listing"

### File::Listing (parse directory listing)
# File::Listing Perl модуль

# Required:    perl-http-date
# Recommended: no
# Optional:    no
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/File/Listing/.packlist"
...
# Package: ${PRGNAME} (parse directory listing)
#
# File::Listing parses a directory listing
#
# Home page: https://metacpan.org/pod/File::Listing
