...
PRGNAME="perl-test-exception"
ARCH_NAME="Test-Exception"

### Test::Exception (test exception-based code)
# Test::Exception Perl модуль

# Required:    perl-sub-uplevel
# Recommended: no
# Optional:    no
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Test/Exception/.packlist"
...
# Package: ${PRGNAME} (test exception-based code)
#
# Test::Exception provides convenience methods for testing exception based code
#
# Home page: https://metacpan.org/pod/Test::Exception
