...
PRGNAME="perl-algorithm-diff"
ARCH_NAME="Algorithm-Diff"

### Algorithm::Diff (compute 'intelligent' differences between two files/lists)
# Algorithm::Diff Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Algorithm/Diff/.packlist"
...
# Package: ${PRGNAME} (compute 'intelligent' differences between two files/lists)
#
# Algorithm::Diff computes 'intelligent' differences between two files or lists
#
# Home page: https://metacpan.org/pod/Algorithm::Diff
