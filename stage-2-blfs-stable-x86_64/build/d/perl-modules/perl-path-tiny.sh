...
PRGNAME="perl-path-tiny"
ARCH_NAME="Path-Tiny"

### Path::Tiny (file path utility)
# Path::Tiny Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Path/Tiny/.packlist"
...
# Package: ${PRGNAME} (file path utility)
#
# Path::Tiny provides a small fast utility for working with file paths
#
# Home page: https://metacpan.org/pod/Path::Tiny
