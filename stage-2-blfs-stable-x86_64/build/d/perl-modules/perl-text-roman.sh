...
PRGNAME="perl-text-roman"
ARCH_NAME="Text-Roman"

### Text::Roman (allows conversion between roman and arabic algarisms)
# Text::Roman Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Text/Roman/.packlist"
...
# Package: ${PRGNAME} (allows conversion between roman and arabic algarisms)
#
# Text::Roman allows conversion between Roman and Arabic algorisms (number
# systems, e.g. MCMXLV and 1945)
#
# Home page: https://metacpan.org/pod/Text::Roman
# Download:  https://www.cpan.org/authors/id/S/SY/SYP/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
