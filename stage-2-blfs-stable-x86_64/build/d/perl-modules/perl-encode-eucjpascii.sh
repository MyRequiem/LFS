...
PRGNAME="perl-encode-eucjpascii"
ARCH_NAME="Encode-EUCJPASCII"

### Encode::EUCJPASCII (eucJP-ascii - an eucJP-open mapping)
# Encode::EUCJPASCII Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Encode/EUCJPASCII/.packlist"
...
# Package: ${PRGNAME} (eucJP-ascii - an eucJP-open mapping)
#
# Encode::EUCJPASCII provides an eucJP-open (Extended Unix Code, Japanese)
# mapping
#
# Home page: https://metacpan.org/pod/Encode::EUCJPASCII
