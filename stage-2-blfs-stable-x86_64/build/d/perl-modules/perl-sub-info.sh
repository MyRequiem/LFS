...
PRGNAME="perl-sub-info"
ARCH_NAME="Sub-Info"

### Sub::Info (tool for inspecting subroutines)
# Sub::Info Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Sub/Info/.packlist"
...
# Package: ${PRGNAME} (tool for inspecting subroutines)
#
# Sub::Info is a tool for inspecting subroutines
#
# Home page: https://metacpan.org/pod/Sub::Info
