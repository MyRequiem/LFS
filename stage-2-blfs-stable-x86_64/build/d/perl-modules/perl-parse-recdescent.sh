...
PRGNAME="perl-parse-recdescent"
ARCH_NAME="Parse-RecDescent"

### Parse::RecDescent (generate recursive-descent parsers)
# Parse::RecDescent Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Parse/RecDescent/.packlist"
...
# Package: ${PRGNAME} (generate recursive-descent parsers)
#
...
#
# Home page: https://metacpan.org/pod/Parse::RecDescent
# Download:  https://www.cpan.org/authors/id/J/JT/JTBRAUN/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
