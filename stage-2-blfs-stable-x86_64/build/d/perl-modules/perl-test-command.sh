...
PRGNAME="perl-test-command"
ARCH_NAME="Test-Command"

### Test::Command (test routines for external commands)
# Test::Command Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Test/Command/.packlist"
...
# Package: ${PRGNAME} (test routines for external commands)
#
# Test::Command tests the exit status, STDOUT, or STDERR, of an external
# command
#
# Home page: https://metacpan.org/pod/Test::Command
# Download:  https://www.cpan.org/authors/id/D/DA/DANBOO/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
