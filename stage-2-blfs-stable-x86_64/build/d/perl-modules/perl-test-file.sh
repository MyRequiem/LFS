...
PRGNAME="perl-test-file"
ARCH_NAME="Test-File"

### Test::File (test file attributes)
# Test::File Perl модуль

# Required:    no
# Recommended: perl-test-utf8 (для тестов)
# Optional:    no
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Test/File/.packlist"
...
# Package: ${PRGNAME} (test file attributes)
#
