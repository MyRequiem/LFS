...
PRGNAME="perl-importer"
ARCH_NAME="Importer"

### Importer (interface to modules that export symbols)
# Importer Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Importer/.packlist"
...
# Package: ${PRGNAME} (interface to modules that export symbols)
#
# Importer provides an alternative but compatible interface to modules that
# export symbols
#
# Home page: https://metacpan.org/pod/Importer
