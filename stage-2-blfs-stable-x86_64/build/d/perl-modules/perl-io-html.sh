...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/IO/HTML/.packlist"
...
# Package: ${PRGNAME} (open an HTML file with automatic charset detection)
#
# IO::HTML opens an HTML file with automatic character set detection
#
# Home page: https://metacpan.org/pod/IO::HTML
# Download:  https://cpan.metacpan.org/authors/id/C/CJ/CJM/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
