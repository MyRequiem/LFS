...
PRGNAME="perl-test-needs"
ARCH_NAME="Test-Needs"

### Test::Needs (skips tests if a requested module is not present)
# Test::Needs Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Test/Needs/.packlist"
...
# Package: ${PRGNAME} (skips tests if a requested module is not present)
#
# Test::Needs skips tests if a requested module is not present
#
# Home page: https://metacpan.org/pod/Test::Needs
