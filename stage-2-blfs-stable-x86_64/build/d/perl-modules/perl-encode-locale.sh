...
PRGNAME="perl-encode-locale"
ARCH_NAME="Encode-Locale"

### Encode::Locale (determine the locale encoding)
# Encode::Locale Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Encode/Locale/.packlist"
...
# Package: ${PRGNAME} (determine the locale encoding)
#
# Encode::Locale determines the locale encoding
#
# Home page: https://metacpan.org/pod/Encode::Locale
