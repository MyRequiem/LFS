...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Sort/Key/.packlist"
...
# Package: ${PRGNAME} (the fastest way to sort anything in Perl)
#
# Sort::Key provides a set of functions to sort lists of values by some
# calculated key value
#
# Home page: https://metacpan.org/pod/Sort::Key
# Download:  https://www.cpan.org/authors/id/S/SA/SALVA/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
