...
PRGNAME="perl-xml-namespacesupport"
ARCH_NAME="XML-NamespaceSupport"

### XML::NamespaceSupport (a simple generic namespace processor)
# XML::NamespaceSupport Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/XML/NamespaceSupport/.packlist"
...
# Package: ${PRGNAME} (a simple generic namespace processor)
#
# XML::NamespaceSupport offers a simple way to process namespaced XML names
# from within any application that may need them
#
# Home page: https://metacpan.org/pod/XML::NamespaceSupport
# Download:  https://cpan.metacpan.org/authors/id/P/PE/PERIGRIN/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
