...
# Инструмент для работы с книжными кодами ISBN. Он умеет проверять их
# правильность, преобразовывать старые 10-значные номера в новые 13-значные и
# извлекать из них информацию об издателе.
