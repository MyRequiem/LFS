...
PRGNAME="perl-test-utf8"
ARCH_NAME="Test-utf8"

### Test::utf8 (handy utf8 tests)
# Test::utf8 Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Test/utf8/.packlist"
...
# Package: ${PRGNAME} (handy utf8 tests)
#
# Test::utf8 is a collection of tests useful for dealing with utf8 strings in
# Perl
#
# Home page: https://metacpan.org/pod/Test::utf8
# Download:  https://cpan.metacpan.org/authors/id/M/MA/MARKF/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
