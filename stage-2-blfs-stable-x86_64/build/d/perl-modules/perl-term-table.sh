...
PRGNAME="perl-term-table"
ARCH_NAME="Term-Table"

### Term::Table (formats a header and rows into a table)
# Term::Table Perl модуль

# Required:    perl-importer
# Recommended: no
# Optional:    no
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Term/Table/.packlist"
...
# Package: ${PRGNAME} (formats a header and rows into a table)
#
...
#
# Home page: https://metacpan.org/pod/Term::Table
