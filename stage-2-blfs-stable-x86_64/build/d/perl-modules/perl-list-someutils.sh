...
PRGNAME="perl-list-someutils"
ARCH_NAME="List-SomeUtils"

### List::SomeUtils (provide the stuff missing in List::Util)
# List::SomeUtils Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/List/SomeUtils/.packlist"
...
#
# Home page: https://metacpan.org/pod/List::SomeUtils
