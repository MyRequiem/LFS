...
PRGNAME="perl-timedate"
ARCH_NAME="TimeDate"

### TimeDate (Time and Date manipulation)
# TimeDate Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Date/Parse/.packlist"
...
# Package: ${PRGNAME} (Time and Date manipulation)
#
