...
PRGNAME="perl-io-string"
ARCH_NAME="IO-String"

### IO::String (emulate file interface for in-core strings)
# IO::String Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/IO/String/.packlist"
...
# Package: ${PRGNAME} (emulate file interface for in-core strings)
#
# IO::String - Emulate file interface for in-core strings
#
# Home page: https://metacpan.org/pod/IO::String
# Download:  https://www.cpan.org/authors/id/G/GA/GAAS/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
