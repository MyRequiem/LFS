...
PRGNAME="perl-list-allutils"
ARCH_NAME="List-AllUtils"

### List::AllUtils (combines List::Util and List::MoreUtils in one bite-sized package)
# List::AllUtils Perl модуль

# Required:    perl-list-someutils
#              perl-list-utilsby
# Recommended: no
# Optional:    no
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/List/AllUtils/.packlist"
...
# Package: ${PRGNAME} (combines List::Util and List::MoreUtils in one bite-sized package)
#
# The List::Allutils module combines List::Util and List::MoreUtils in one
# bite-sized package
#
# Home page: https://metacpan.org/pod/List::AllUtils
