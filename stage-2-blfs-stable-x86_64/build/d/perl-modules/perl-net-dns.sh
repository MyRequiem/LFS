...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Net/DNS/.packlist"
...
# Package: ${PRGNAME} (Perl Interface to the Domain Name System)
#
# Net::DNS is a DNS resolver implemented in Perl. It can be used to perform
# nearly any type of DNS query from a Perl script
#
# Home page: https://metacpan.org/pod/Net::DNS
# Download:  https://www.cpan.org/authors/id/N/NL/NLNETLABS/${ARCH_NAME}-${VERSION}.tar.gz
#
EOF
