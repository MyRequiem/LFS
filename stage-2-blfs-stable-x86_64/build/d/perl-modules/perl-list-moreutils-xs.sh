...
PRGNAME="perl-list-moreutils-xs"
ARCH_NAME="List-MoreUtils-XS"

### List::MoreUtils::XS (provide compiled List::MoreUtils functions)
# List::MoreUtils::XS Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/List/MoreUtils/XS/.packlist"
...
# Package: ${PRGNAME} (provide compiled List::MoreUtils functions)
#
# List::MoreUtils::XS is a compiled backend for List::MoreUtils
#
# Home page: https://metacpan.org/pod/List::MoreUtils::XS
