...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Role/Tiny/.packlist"
...
# Package: ${PRGNAME} (Roles: a nouvelle cuisine portion size slice of Moose)
#
# Role::Tiny is a minimalist role composition tool
#
# Home page: https://metacpan.org/pod/Role::Tiny
