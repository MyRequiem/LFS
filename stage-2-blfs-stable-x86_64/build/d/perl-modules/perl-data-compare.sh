...
PRGNAME="perl-data-compare"
ARCH_NAME="Data-Compare"

### Data::Compare (Data::Compare module compares two perl data structures)
# Perl модуль для сравнения двух структур данных
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Data/Compare/.packlist"
...
# Package: ${PRGNAME} (Data::Compare module compares two perl data structures)
#
# The Data::Compare module compares two perl data structures
#
# Home page: https://metacpan.org/pod/Data::Compare
