...
PRGNAME="perl-unicode-collate"
ARCH_NAME="Unicode-Collate"

### Unicode::Collate (Unicode Collation Algorithm)
# Unicode::Collate Perl модуль
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/Unicode/Collate/.packlist"
...
# Package: ${PRGNAME} (Unicode Collation Algorithm)
#
