...
PRGNAME="perl-cpan-meta-check"
ARCH_NAME="CPAN-Meta-Check"
...
sed -e "s|${TMP_DIR}||" -i \
    "${TMP_DIR}${PERL_LIB_PATH}/site_perl/auto/CPAN/Meta/Check/.packlist"
...
# Package: ${PRGNAME} (Verify requirements in a CPAN::Meta object)
#
# CPAN::Meta::Check verifies if requirements described in a CPAN::Meta object
# are present
#
# Home page: https://metacpan.org/pod/CPAN::Meta::Check
