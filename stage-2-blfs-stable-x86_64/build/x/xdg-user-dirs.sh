...
# http://www.linuxfromscratch.org/blfs/view/stable/general/xdg-user-dirs.html

# Home page: http://freedesktop.org/wiki/Software/xdg-user-dirs
# Download:  https://user-dirs.freedesktop.org/releases/xdg-user-dirs-0.17.tar.gz
