...
# Профессиональный набор инструментов для работы с языками мира. Отвечает за
# правильную сортировку списков, форматы дат, времени и т.д.
...
SOURCES="${ROOT}/src"
VERSION="$(find ${SOURCES} -type f -name "${ARCH_NAME}-*" | rev | \
...
# Download:  https://github.com/unicode-org/${PRGNAME}/releases/download/release-${VERSION}/${ARCH_NAME}-${VERSION}-sources.tgz
#
EOF
