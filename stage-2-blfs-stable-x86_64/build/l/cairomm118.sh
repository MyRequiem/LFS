...
# Последнее поколение графического интерфейса на C++ для библиотеки Cairo.
# Позволяет создавать высококачественную графику с аппаратным ускорением и
# безупречной четкостью (версия 1.18).
