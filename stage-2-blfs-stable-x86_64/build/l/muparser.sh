...
# Очень быстрая математическая библиотека для разбора и вычисления сложных
# математических формул, заданных в виде обычного текста. Она мгновенно
# вычисляет значения уравнений внутри программ.
