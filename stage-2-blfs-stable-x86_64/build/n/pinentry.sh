...
# Простое и безопасное диалоговое окно для ввода ПИН - кодов или паролей к
# секретным ключам. Оно спроектировано так, чтобы другие программы не могли
# «подсмотреть» то, что вы вводите с клавиатуры.
