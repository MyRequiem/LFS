...
# Набор классических стилей оформления, которые определяют, как именно будут
# выглядеть SGML-документы (DocBook) при печати или в HTML. В отличие от
# современных XSL-стилей, этот пакет использует старый стандарт DSSSL для
# превращения исходного кода в готовый сверстанный текст.
