...
# Полнофункциональный консольный скрипт, который собирает и выводит подробную
# информацию об аппаратной части компьютера и операционной системе. Он идеален
# для быстрой диагностики железа.
