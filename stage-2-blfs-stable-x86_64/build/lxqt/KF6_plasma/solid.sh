...
# Специализированный слой совместимости внутри KDE, который отвечает за
# обнаружение и мониторинг подключенного к компьютеру железа. Он сообщает
# системе о вставленной флешке или уровне заряда батареи.
