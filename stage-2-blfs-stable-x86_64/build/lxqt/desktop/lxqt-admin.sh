...
# Package: ${PRGNAME} (GUI tools to adjust settings of the operating system)
#
# The lxqt-admin package provides two GUI tools to adjust settings of the
# operating system LXQt is running on
#
