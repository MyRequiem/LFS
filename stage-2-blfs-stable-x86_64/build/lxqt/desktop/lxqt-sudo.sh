...
# Графическая утилита, которая позволяет запускать текстовые команды или другие
# приложения с правами суперпользователя root. Она запрашивает пароль через
# простое диалоговое окно, обеспечивая безопасное администрированию системы.
