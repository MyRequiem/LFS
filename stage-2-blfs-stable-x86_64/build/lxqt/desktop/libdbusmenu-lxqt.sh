...
# Recommended: no
# Optional:    doxygen
#              qjson        (https://qjson.sourceforge.net/)
...
# Package: ${PRGNAME} (Qt implementation of the DBusMenu protocol)
#
# The libdbusmenu-lxqt package provides a Qt implementation of the DBusMenu
# protocol
#
