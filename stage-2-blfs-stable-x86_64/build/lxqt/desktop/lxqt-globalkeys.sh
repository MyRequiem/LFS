...
# Package: ${PRGNAME} (a daemon used to register global keyboard shortcuts)
#
# The lxqt-globalkeys package contains a daemon used to register global
# keyboard shortcuts as well as an editor for keyboard shortcuts
#
