...
# Специализированный программный виджет терминала на базе Qt, предназначенный
# для разработчиков. Он служит готовым внутренним компонентом, на основе
# которого строятся другие полноценные программы-эмуляторы терминала, например,
# qterminal.
