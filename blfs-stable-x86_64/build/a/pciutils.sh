...
# Download:  https://www.kernel.org/pub/software/utils/pciutils/pciutils-3.6.4.tar.xz
...
UPDATE_PCIIDS="/etc/cron.weekly/update-pciids.sh"
...
cp "${UPDATE_PCIIDS}" "${TMP_DIR}/etc/cron.weekly/"
