...
# http://www.linuxfromscratch.org/blfs/view/stable/postlfs/ntfs-3g.html
...
# ссылка в /sbin mount.ntfs -> ../bin/ntfs-3g
ln -sv ../bin/ntfs-3g /sbin/mount.ntfs
# ссылка в /usr/share/man/man8 mount.ntfs.8 -> ntfs-3g.8
