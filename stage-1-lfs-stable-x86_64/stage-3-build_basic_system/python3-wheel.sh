...
# Формат пакетов для Python, который позволяет устанавливать программы гораздо
# быстрее, чем при сборке из исходников. Утилита wheel служит для упаковки,
# раскаповки и конвертации wheel-архивов.
