...
# Огромная коллекция системных утилит на все случаи жизни - работа с файловыми
# системами, консолями, разделами жесткого диска, системными сообщениями и др.
...
# WARNING:
#    Для запуска тестов в конфигурации ядра хоста должен быть установлен
#    параметр CONFIG_SCSI_DEBUG как модуль.
#
