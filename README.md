...
необходимые для сборки готовых исполняемых бинарных файлов из исходного кода:
    * [GCC, the GNU Compiler Collection][11] 16.2.0 (07-08-2026)
    * [GNU Binutils][13] 2.47 (26-07-2026)
    * [Glibc, the GNU C Library][12] 2.44 (24-07-2026)
* [Linux Kernel][14] 7.1.12 (28-08-2026)
...
Оригинальный [LFS][22] использует udev из состава systemd просто потому, что в
апреле 2012 года проект udev как самостоятельная единица перестал существовать
и был поглощен системой инициализации systemd. Разработчики объединили исходный
код udev с деревом исходников systemd. Тянуть огромный архив systemd только
ради одной директории исходного кода udev - сомнительное удовольствие.
[Eudev][23] (форк от Gentoo) - считаю идеальной заменой:
* ` Независимость `: Создан специально для работы без systemd и отлично
дружит с SysVinit.
...
При масштабе в 700+ пакетов документирование каждого «костыля» в отдельном
...
[24]: https://gitflic.ru/project/myrequiem/lfs
